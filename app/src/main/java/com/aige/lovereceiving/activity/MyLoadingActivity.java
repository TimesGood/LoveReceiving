...
public class MyLoadingActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = MyLoadingActivity.this;
        bindViews();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_one:
                ...
                ProgressDialog.show(MyLoadingActivity.this, "资源加载中", "资源加载中,请稍后...",false,true);
                break;
            case R.id.btn_two:
            ...
            case R.id.btn_three:
                ...
                add = 0;
                //依次设置一些属性
                pd2 = new ProgressDialog(MyLoadingActivity.this);
                pd2.setMax(MAXVALUE);
                pd2.setTitle("文件读取中");
